...
public class EntryActivitym extends BaseActivity {
    ...
    private void showErrorMessage(String errorMessage) {
        progressBar.setVisibility(View.GONE);
        Log.e("EntryActivitym", "error fetching sticker packs, " + errorMessage);
    ...
    static class LoadListAsyncTask extends AsyncTask<Void, Void, Pair<String, ArrayList<StickerPack>>> {
        private final WeakReference<EntryActivitym> contextWeakReference;

        LoadListAsyncTask(EntryActivitym activity) {
        ...
        protected Pair<String, ArrayList<StickerPack>> doInBackground(Void... voids) {
            ...
            try {
                ...
                Log.e("EntryActivitym", "error fetching sticker packs", e);
        ...
        protected void onPostExecute(Pair<String, ArrayList<StickerPack>> stringListPair) {
            ...
            final EntryActivitym entryActivitym = contextWeakReference.get();
            if (entryActivitym != null) {
                if (stringListPair.first != null) {
                    entryActivitym.showErrorMessage(stringListPair.first);
                } else {
                    entryActivitym.showStickerPack(stringListPair.second);
                }
            }
        }
    }
